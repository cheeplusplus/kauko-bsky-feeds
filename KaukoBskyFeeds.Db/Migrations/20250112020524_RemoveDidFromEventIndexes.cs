...
namespace KaukoBskyFeeds.Db.Migrations
{
    ...
    public partial class RemoveDidFromEventIndexes : Migration
    {
        ...
        {
            migrationBuilder.DropIndex(name: "IX_Posts_EventTime_Did", table: "Posts");
        ...
        {
            migrationBuilder.DropIndex(name: "IX_Posts_EventTime", table: "Posts");

            migrationBuilder.DropIndex(name: "IX_PostReposts_EventTime", table: "PostReposts");

            migrationBuilder.DropIndex(name: "IX_PostReplies_EventTime", table: "PostReplies");
            ...
            migrationBuilder.DropIndex(name: "IX_PostLikes_EventTime", table: "PostLikes");
